/* ===========================================================
   カードデータ ── 武将（出世ライン）・装備・采配・陣形
   設計: 無名の兵士(たね) → 名を挙げて有名武将(侍大将) → 大名(伝説)
   数値はポケポケに倣い小さめ（首級3点で決着）。バランスはテストプレイで調整。
   グローバル CARDS に格納（クラシックscript・モジュール不使用）。
   =========================================================== */
(function () {
  // 勢力（家）の定義：色・三すくみ相性
  const FACTIONS = {
  ...
  // 武将カード共通: { id, type:'warlord', name, yomi, rank, stage, evolvesFrom, faction,
  //   hp, ability, moves:[{name,cost,dmg,text,effect}], weakness(相性), retreat, kubi, legend, art, flavor }
  // cost は兵の数（数値）。dmg は基本ダメージ。
  const C = {};
  ...
  C['騎馬武者'] = { id:'騎馬武者', type:'warlord', name:'騎馬武者', yomi:'きばむしゃ', rank:'たね', stage:0, evolvesFrom:null, faction:'無所属', heisyu:'騎',
    hp:100, ability:null, moves:[{name:'駆け抜け', cost:1, dmg:20, text:'相手の後備え1体にも5。', effect:{benchSplash:5}}], weakness:null, retreat:1, kubi:1,
  ...
  C['槍足軽']   = { id:'槍足軽', type:'warlord', name:'槍足軽', yomi:'やりあしがる', rank:'たね', stage:0, evolvesFrom:null, faction:'無所属', heisyu:'槍',
    hp:100, ability:null, moves:[{name:'一番槍', cost:1, dmg:30, text:''},{name:'繰り出し突き', cost:2, dmg:55, text:''}], weakness:null, retreat:1, kubi:1,
  ...
  C['弓兵']     = { id:'弓兵', type:'warlord', name:'弓兵', yomi:'ゆみへい', rank:'たね', stage:0, evolvesFrom:null, faction:'無所属', heisyu:'弓',
    hp:90, ability:null, moves:[{name:'遠矢', cost:1, dmg:15, text:'相手の後備え1体に20。', effect:{benchTarget:20}},{name:'差し矢', cost:2, dmg:45, text:''}], weakness:null, retreat:1, kubi:1,
  ...
  C['鉄砲足軽'] = { id:'鉄砲足軽', type:'warlord', name:'鉄砲足軽', yomi:'てっぽうあしがる', rank:'たね', stage:0, evolvesFrom:null, faction:'無所属', heisyu:'砲',
    hp:80, ability:null, moves:[{name:'斉射', cost:1, dmg:25, text:''},{name:'火縄', cost:2, dmg:55, text:''}], weakness:null, retreat:1, kubi:1,
  ...
  C['明智光秀'] = { id:'明智光秀', type:'warlord', name:'明智光秀', yomi:'あけち みつひで', rank:'侍大将', stage:1, evolvesFrom:'足軽', faction:'織田', heisyu:'歩',
    hp:130, ability:{name:'律儀者', text:'このカードがダメージを受けても、相手から状態異常を受けない。', type:'passive'},
    moves:[{name:'寄せ太鼓', cost:1, dmg:30, text:''},{name:'桔梗の采', cost:2, dmg:60, text:''}], weakness:'豊臣', retreat:2, kubi:2,
  ...
  C['山県昌景'] = { id:'山県昌景', type:'warlord', name:'山県昌景', yomi:'やまがた まさかげ', rank:'侍大将', stage:1, evolvesFrom:'騎馬武者', faction:'武田', heisyu:'騎',
    hp:140, ability:null,
    moves:[{name:'物見', cost:1, dmg:30, text:''},{name:'赤備え', cost:2, dmg:50, text:'相手の後備え全員に5。', effect:{benchAll:5}}], weakness:'織田', retreat:2, kubi:2,
  ...
  C['直江兼続'] = { id:'直江兼続', type:'warlord', name:'直江兼続', yomi:'なおえ かねつぐ', rank:'侍大将', stage:1, evolvesFrom:'槍足軽', faction:'上杉', heisyu:'槍',
    hp:130, ability:{name:'愛の兜', text:'自分のターン開始時、この武将のダメージを10回復する。', type:'passive'},
    moves:[{name:'義の一槍', cost:2, dmg:50, text:''}], weakness:'武田', retreat:2, kubi:2,
  ...
  C['本多忠勝'] = { id:'本多忠勝', type:'warlord', name:'本多忠勝', yomi:'ほんだ ただかつ', rank:'侍大将', stage:1, evolvesFrom:'槍足軽', faction:'徳川', heisyu:'槍',
    ...
    moves:[{name:'蜻蛉切', cost:2, dmg:70, text:''}], weakness:'上杉', retreat:2, kubi:2,
  ...
  C['木下藤吉郎'] = { id:'木下藤吉郎', type:'warlord', name:'木下藤吉郎', yomi:'きのした とうきちろう', rank:'侍大将', stage:1, evolvesFrom:'足軽', faction:'豊臣', heisyu:'歩',
    ...
    moves:[{name:'一夜城', cost:1, dmg:40, text:''},{name:'墨俣築城', cost:2, dmg:65, text:''}], weakness:'徳川', retreat:1, kubi:2,
    art:'art/images/tokichiro.png', flavor:'草履を懐で温めた男。天下はもう目の前。' };

  // ---------- 大名（伝説・本陣の切り札）----------
  // daimyo:true … デッキには入らず「本陣」に最初から控える。前線が全滅すると最後の砦として出陣。
  // 大名を討たれたら敗北（勝利＝敵大名の撃破）。出世はしない（名持ち→名持ちの進化はなし）。
  C['織田信長'] = { id:'織田信長', type:'warlord', name:'織田信長', yomi:'おだ のぶなが', rank:'大名', stage:2, daimyo:true, evolvesFrom:null, faction:'織田', heisyu:'歩', legend:true,
    ...
    moves:[{name:'天下布武', cost:3, dmg:120, text:''},{name:'鉄砲三段', cost:2, dmg:60, text:'相性を突くとさらに+20。'}], weakness:'豊臣', retreat:1, kubi:3,
  ...
  C['武田信玄'] = { id:'武田信玄', type:'warlord', name:'武田信玄', yomi:'たけだ しんげん', rank:'大名', stage:2, daimyo:true, evolvesFrom:null, faction:'武田', heisyu:'騎', legend:true,
    ...
    moves:[{name:'騎馬突撃', cost:3, dmg:110, text:''}], weakness:'織田', retreat:1, kubi:3,
  ...
  C['徳川家康'] = { id:'徳川家康', type:'warlord', name:'徳川家康', yomi:'とくがわ いえやす', rank:'大名', stage:2, daimyo:true, evolvesFrom:null, faction:'徳川', heisyu:'槍', legend:true,
    ...
    moves:[{name:'鶴翼の陣', cost:3, dmg:100, text:''}], weakness:'上杉', retreat:1, kubi:3,
    art:'art/images/ieyasu.png', flavor:'鳴くまで待とう。最後に天下を掴む狸。' };
  C['豊臣秀吉'] = { id:'豊臣秀吉', type:'warlord', name:'豊臣秀吉', yomi:'とよとみ ひでよし', rank:'大名', stage:2, daimyo:true, evolvesFrom:null, faction:'豊臣', heisyu:'歩', legend:true,
    ...
    moves:[{name:'太閤の采配', cost:3, dmg:110, text:''}], weakness:'徳川', retreat:1, kubi:3,
  ...
  // ---------- 采配（トレーナーズ）----------
  // kind: 'item'(軍需品/何枚でも) | 'support'(軍師の采配/1ターン1枚) | 'stadium'(陣形/場に1枚)
  ...
  C['狼煙'] = { id:'狼煙', type:'trainer', kind:'item', name:'狼煙', yomi:'のろし', faction:'無所属',
    text:'兵站庫に兵を1ためる。', effect:{energy:1}, art:null, flavor:'天に立ち上る合図。' };
  ...
  C['兵糧調達'] = { id:'兵糧調達', type:'trainer', kind:'support', name:'軍師の采配・兵糧調達', yomi:'ひょうろうちょうたつ', faction:'無所属',
    text:'兵站庫に兵を2ためる。', effect:{energy:2}, art:null, flavor:'兵站を制する者が戦を制す。' };
